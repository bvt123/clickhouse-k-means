...
- перед запуском скрипта надо создать не только view но и пару функций (см. sql)

# Результат

В таблице WCR  есть строка для каждого шага алгоритма и каждого центроида/группы, с указанием таймстемпа и массивом ключей строк исходного массива данных представляющего отдельный кластер для данной эпохи.  Чтобы вытащить необходимые данные, пишите запрос на свой вкус - с джойном или без. Мой вариант в конце sql файла. 
